...
fun_corrige_CUADRO_4_1_anho2016 <- function(text_table,semana,anho) {
	...
	if(semana==28 && anho==2016) {
		...
		text_table[i] <- 'Chiapas    350    4227    7 797   10834    14    119    192    448   3305    41652    52291    104031'
		i <- 8;
	...
	if(semana==33 && anho==2016) {
		...
		text_table[i] <- 'México     32    424    735    1 254    -    42    69    102 10 091    174 162    207 224    382 900'
	}
	if(semana==36 && anho==2016) {
		i <- 15;
		#México     38    473    805    1 359    3    45    76    117 10 370    187 894    223 320    415 869
		text_table[i] <- 'México     38    473    805    1 359    3    45    76    117 10 370    187 894    223 320    415 869'
	}
